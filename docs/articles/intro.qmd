...
The package contains a collection of additional helper functions for creating beautiful tables with [great-tables](https://posit-dev.github.io/great-tables/) in Python.
...
For a more comprehensive guide, head over to the [Get Started](../get-started/) page, and for the most comprehensive guide, see the [docs](../reference/)!
