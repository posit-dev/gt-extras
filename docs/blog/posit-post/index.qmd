...
![](../../examples/nfl-season/2011-nfl-season.png){width=750 fig-align="center"}
...
The cleaning and setup of the data is not my focus in this post, so I will leave the code in a notebook for you to inspect if you wish. In the notebook, we join two datasets, one that gives us 2011 football stats and the other team metadata. Take a look here.

<a href="https://github.com/posit-dev/gt-extras/blob/main/docs/examples/nfl-season/index.ipynb" target="_blank">View notebook ⬀</a>

```{python}
# | code-fold: True
# | code-summary: Show the notebook code
# | output: False
import polars as pl
import statistics
...
With a little bit of patience, *that* (above) will turn into *this* (below).

![](../../examples/nfl-season/2011-nfl-season.png){width=600 fig-align="center"}
