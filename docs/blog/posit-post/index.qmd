...
def make_table(nfl_df_polars) -> GT:
    gt = (
        GT(nfl_df_polars, rowname_col="Team", groupname_col="team_division")
        .tab_header(
...
gte.gt_two_column_layout(gt1, gt2, table_header_from=1, target="browser")
```
